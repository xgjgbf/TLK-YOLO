...
from .modules.block import ( C3_DSConv2D, C2f_DSConv2D, DSConv2D, DCLSK,LWCA)
from .modules.head import (Detect_DS)


# from .modules.ex_module import (LocalWindowAttention, deformable_LKA, LSKBlock_SA, EMA, CBAM)
# from .modules.HaloAttention import HaloAttention
try:
    import thop
except ImportError:
    ...
    for i, (f, n, m, args) in enumerate(d["backbone"] + d["head"]):  # from, number, module, args
        ...
        if m in base_modules:
            ...
            if m in repeat_modules:
                ...
                n = 1
            if m in {C3k2, C2f, C3}:  # for M/L/X sizes
                legacy = False
                if scale in "mlx":
                    args[3] = True
